...
const FooterNav: React.FC<FooterProps> = ({ section }) => {
  ...
  const navigation = {
    ...
    legal: [
      {
        name: translate('footer_legal_name_row1'),
        href: 'https://github.com/feature-sh/common/blob/main/POLICY.md',
      },
    ],
    social: [
      {
        name: 'Twitter',
        href: 'https://twitter.com/feature_sh',
        icon: (props: any) => (
      ...
      // TODO these social media are hidden in waiting the social network setup
      // {
      //   name: 'Facebook',
      //   href: '#',
      //   icon: (props: any) => (
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-400">
                  {translate('footer_company_title')}
                </h3>
                <FooterNav section="company" />
              </div>
              <div className="mt-12 md:mt-0">
                <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-400">
                  {translate('footer_legal_title')}
                </h3>
